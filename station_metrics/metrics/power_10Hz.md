...
5. Find the period bin whose center is closest to 0.1 s and report the power in
   that bin:
...
exactly 0.1 s. The bin center may therefore be a few percent away from the
